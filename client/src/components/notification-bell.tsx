  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="relative flex items-center justify-center w-9 h-9 rounded-lg hover:bg-slate-800 transition-colors no-scale"
      ...
      >
        ...
        {unreadCount > 0 && (
          <span
            ...
            className="absolute -top-0.5 -right-0.5 flex items-center justify-center min-w-[18px] h-[18px] px-1 rounded-full bg-red-500 text-white text-[10px] font-bold leading-none animate-pulse"
          >
