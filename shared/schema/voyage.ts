...
export const cargoParcels = pgTable("cargo_parcels", {
  ...
  consigneeName: varchar("consignee_name", { length: 300 }),
  shipperName: varchar("shipper_name", { length: 300 }),
  cargoGrade: varchar("cargo_grade", { length: 200 }),
  tankNumbers: varchar("tank_numbers", { length: 200 }),
  blQuantity: real("bl_quantity"),
  shippedQuantity: real("shipped_quantity"),
  receivedQuantity: real("received_quantity"),
  shortageQuantity: real("shortage_quantity"),
  loadingSequence: integer("loading_sequence"),
  dischargeSequence: integer("discharge_sequence"),
  operationStatus: varchar("operation_status", { length: 30 }).default("waiting"),
  equipmentUsed: varchar("equipment_used", { length: 200 }),
  hosesConnected: integer("hoses_connected"),
  cranesAssigned: varchar("cranes_assigned", { length: 200 }),
  operationStartedAt: timestamp("operation_started_at"),
  operationCompletedAt: timestamp("operation_completed_at"),
