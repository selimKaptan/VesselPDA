...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "ws:", "wss:", "https://api.anthropic.com", "https://nominatim.openstreetmap.org", "https://stream.aisstream.io", "https://tiles.stadiamaps.com", "https://*.tile.openstreetmap.org", "https://api.mapbox.com", "https://events.mapbox.com", "https://*.mapbox.com"],
      frameSrc: ["'self'"],
      objectSrc: ["'none'"],
      mediaSrc: ["'self'"],
