...
-   **Specialized Modules**: Q88 Vessel Questionnaire, Berthing Fees, VTS Fees, and Harbour Master Dues calculation systems. Cargo Operations, Crew Management enhancements (including hotel reservations), Planned Maintenance System (PMS), Bunker Management, Charter Party & TC Hire Management, Port Call Management, Husbandry Services, Environmental Compliance (CII/EU ETS/IMO DCS), Insurance Management, Drydock Management, Defect & PSC Tracking, Spare Parts Inventory, Passage Planning.
